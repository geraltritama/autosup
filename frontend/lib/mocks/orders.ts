...
export const mockOrders: OrderDetail[] = [
  ...
  },
  {
    ...
    items: [
      { item_name: "Kopi Arabika", qty: 30, unit: "kg", price_per_unit: 85000, subtotal: 2550000 },
      { item_name: "Gula Pasir", qty: 20, unit: "kg", price_per_unit: 16000, subtotal: 320000 },
    ],
    total_amount: 2870000,
    status: "pending",
    escrow_status: "held",
    delivery_address: "Jl. Hayam Wuruk No.15, Jakarta Barat",
    notes: "Mohon kirim hari ini jika memungkinkan",
